...
public class FloorDetailsProcessing extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        editor.commit();
        String floorDetails="http://192.168.2.9/49ersense/home/floordetails.php";
        String updateThermoControl="http://192.168.2.9/49ersense/home/updatecontroltemp.php";
        String updateFan="http://192.168.2.9/49ersense/home/updatefan.php";
        String updateMode="http://192.168.2.9/49ersense/home/updatemode.php";
        String updateLight="http://192.168.2.9/49ersense/home/updatelights.php";
